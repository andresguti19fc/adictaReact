...
const Card  = () => {
    ...
    const cards = [
        ...
        {title: "Envios Gratis desde $ 5000.", icon: faGifts, description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates ' }, 
        {title: "Seguridad desde principio a fin.", icon: faHeartbeat, description: ' sapiente dolor pariatur quo aut veritatis cum sed magnam voluptas placeat, dolore fuga ipsum voluptatem mollitia.'}]
